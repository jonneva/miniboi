...
void drawRoad() {
   ...
   for (int i=NUMCARS; i >-1; i--) {
        ...
        if(z-z_world==0) z++;
        y = (Y_CAMERA / (z-z_world)) + dynamichz/5 + hilloffset/24;
        //y = (Y_CAMERA / (z-z_world));
        #ifdef CURVED
            ...
            if (z-z_world > 1500) {
                    ...
                    coffset=0;
                    #endif
                    x = TVXCENTER+(roadx*xlookup[TVY-y-3]/DXDIV)+x*xlookup[TVY-y-3]/DXDIV+coffset;
            ...
            if (z-z_world > 500) {
                    ...
                    coffset=0;
                    #endif
                     x = TVXCENTER+(roadx*xlookup[TVY-y-5]/DXDIV)+x*xlookup[TVY-y-5]/DXDIV+coffset;
            ...
            if (z-z_world > 200) {
                    ...
                    #endif
                    coffset=0;
                    //x = TVXCENTER+(roadx*xlookup[TVY-y-8]/DXDIV)+x*xlookup[TVY-y-8]/DXDIV+coffset;
                    //x = TVXCENTER-4*xlookup[TVY-y-20+dynamichz+hilloffset/400]/DXDIV;
                    x = TVXCENTER-10+(roadx*xlookup[TVY-y]/8);
                    ...
                    alphabitmap(x,y,porsche_med,porsche_med_alpha);
            ...
            if (z-z_world > 30) {
                    ...
                    coffset=0;
                    #endif
                    x = TVXCENTER+(roadx*xlookup[TVY-y-9]/DXDIV)+x*xlookup[TVY-y-9]/DXDIV+coffset;
                    if(x>0 && y < TVY-21 && x< TVX-10) alphabitmap(x,y,porsche_med,porsche_med_alpha);
            }}}}}}}
    #endif // TRAFFIC
}
